...
void MGPIO_voidSetAF(u8 Copy_u8PORT, u8 Copy_u8PIN, u8 Copy_u8AFSelection)
{
	...
	case GPIOA_PORT :
		if(Copy_u8PIN <=7)
		{
			...
			GPIOA->AFRL |= ( Copy_u8AFMode ) << ( Copy_u8PIN * 4 );
		...
		else if(Copy_u8PIN <=15)
		{
			...
			GPIOA->AFRH |= ( Copy_u8AFMode ) << ( Copy_u8PIN * 4 );
		}
		break;
	...
	case GPIOB_PORT :
		if(Copy_u8PIN <=7)
		{
			...
			GPIOB->AFRL |= ( Copy_u8AFMode ) << ( Copy_u8PIN * 4 );
		...
		else if(Copy_u8PIN <=15)
		{
			...
			GPIOB->AFRH |= ( Copy_u8AFMode ) << ( Copy_u8PIN * 4 );
		}
		break;
	...
	case GPIOC_PORT :
		if(Copy_u8PIN <=7)
		{
			...
			GPIOC->AFRL |= ( Copy_u8AFMode ) << ( Copy_u8PIN * 4 );
		...
		else if(Copy_u8PIN <=15)
		{
			...
			GPIOC->AFRH |= ( Copy_u8AFMode ) << ( Copy_u8PIN * 4 );
		}
		break;
